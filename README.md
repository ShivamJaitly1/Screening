# Screening
# Evaluation Portfolio - Shivam Jaitly

Welcome to my evaluation repository. Below are the deliverables organized according to the evaluation criteria: **Communication (Audio)**, **Tech Skills**, and **Writing Skills**.

---

## 1. Communication and Articulation Skills

* **Audio File:** `Audio.mp3` *(located in this repository)*
